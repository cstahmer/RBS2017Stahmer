...
# put back together as a single character string
this_sentence = paste(c(var_sentences_list[[length(var_sentences_list)]]), collapse=" ")

# now calculate the sentiment value of a sentence
calculate_sentiment(this_sentence[[1]])
