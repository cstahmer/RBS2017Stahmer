...
var_textFile_character = "data/plain_text/mshelley.txt"

# identify the word of interest
var_wordofinterest_character = "monster"
...
# dispersion plot which is calculated on a measure of time
...
plot_title <- paste("Dispersion Plot of token '", var_wordofinterest_character, "' in ", var_textFile_character, sep="")
plot(var_yAxis_vector, main=plot_title,
     xlab="Novel Time - Words Location in Text", ylab=var_wordofinterest_character, type="h", ylim=c(0,1), yaxt='n')
